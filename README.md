[![Build Status](https://github.com/gap-packages/format/workflows/CI/badge.svg?branch=master)](https://github.com/gap-packages/format/actions?query=workflow%3ACI+branch%3Amaster)
